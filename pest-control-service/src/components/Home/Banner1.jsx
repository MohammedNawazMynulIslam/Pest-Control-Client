        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight ">
              Take your service from{" "}
              <span className="text-blue-600">Pest Control</span>
            </h1>
            <p className="mt-3 text-lg text-gray-800 ">
              Introducing our premier pest control company, dedicated to
              safeguarding your home or business from unwanted intruders. With
              years of expertise and a commitment to excellence, we have become
              a trusted name in pest management services.
            </p>
