              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                >
                  ...
                  <button
                    //   onClick={handleAdd()}
                    type="submit"
                    className="w-full text-white dark:bg-violet-400 dark:text-gray-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-800"
                  >
                    Add
                  </button>
                </form>
